...
// const quizData = allQuestion[0]

// let arr = []
// for (let key in quizData) {
//     const item = decodeURIComponent(quizData[key])
//     arr.push(item)
// }
...
//     const item = `${decodeURIComponent(key)}:${decodeURIComponent(quizData[key])}`
//     arr.push(item)
// }
...
//         let itemObj = {}
//         for (let key in item) {
//             itemObj[key] = decodeURIComponent(item[key])
//         }
//         return itemObj
//     })
// }

// console.log(getDecodedData(allQuestion))

// const data = allQuestion.map((item) => {
//     return item
// })
...
// const getAllQuizesData = () => {
//     allQuestion.map((item) => {
//         let arr = []
//         for (let[key, value] in item) {
//             const item = decodeURIComponent(item[key])
//             arr.push(item)
//         }
//         console.log(arr)
//     });
...
getDecodData(allQuestion)
console.log(getDecodData(allQuestion))
